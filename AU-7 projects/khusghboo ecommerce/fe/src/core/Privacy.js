...
const Privacy = () => {
    ...
    return (
        <Base>
            <div style={{ "padding": "30px" }}><div ><div><h2>Privacy Policy</h2>
...
We also use cookies to allow you to enter your password less frequently during a session. Cookies can also help us provide information that is targeted to your interests. Most cookies are "session cookies," meaning that they are automatically deleted from your hard drive at the end of a session. You are always free to decline our cookies if your browser permits, although in that case you may not be able to use certain features on the Website and you may be required to re-enter your password more frequently during a session.</p>
                ...
                <p>Our Website links to other websites that may collect personally identifiable information about you. Buyout.com is not responsible for the privacy practices or the content of those linked websites.</p>
                ...
                <p>If you want to remove your contact information from all Buyout.com lists and newsletters, please visit unsubscribe</p>
                <p><strong>7. Advertisements on Buyout.com</strong></p>
...
address, or telephone number) about your visits to this and other websites in order to provide advertisements about goods and services of interest to you.</p>
                ...
                <p><strong>9. Grievance Officer</strong></p>
